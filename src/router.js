...
const routes = {
    ...
    'courses.users.usage': new Route('/courses/:courseId/users/:userId/usage'),
    'courses.users.conclude': new Route('/courses/:courseId/conclude_user/:enrollmentId'),
    'courses.users.unconclude': new Route('/courses/:courseId/unconclude_user/:enrollmentId'),
    'courses.users.unenroll': new Route('/courses/:courseId/unenroll/:enrollmentId'),
    'courses.users.limit-user-grading': new Route('/courses/:courseId/limit_user_grading/:userId'),
    'courses.users.groups': new Route('/courses/:courseId/groups'),
